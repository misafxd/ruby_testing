...
describe BinaryGame do
  ...
  describe '#player_input' do
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        invalid_input = 'd'
        second_invalid_input = 'e'
        valid_input = '4'
        allow(game_input).to receive(:gets).and_return(invalid_input, second_invalid_input, valid_input)
      end
  ...
  describe '#verify_input' do
    ...
    subject(:game_verify_input) { described_class.new(1, 12) }
    ...
    context 'when given a valid input as argument' do
      ...
      it 'returns valid input' do
        ...
        number = 3
        result = game_verify_input.verify_input(min, max, number)
  ...
  describe '#display_turn_order' do
    ...
    subject(:game_turn) { described_class.new(10, 30) }
