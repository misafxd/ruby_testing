...
describe NumberGame do
  ...
  describe '#player_turn' do
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        ...
        second_letter = 'e'
        valid_input = '6'
        allow(game_loop).to receive(:player_input).and_return(letter, second_letter, valid_input)
      end
  ...
  describe '#final_message' do
    ...
    context 'when count is 2-3' do
      subject(:game) { described_class.new(5, '3', 3) }
      # remove the 'x' before running this test
      it 'outputs correct phrase' do
    ...
    context 'when count is 4 and over' do
      subject(:game) { described_class.new(5, '4', 4) }
      # remove the 'x' before running this test
      it 'outputs correct phrase' do
        harder_phrase =  "That was hard. It took you 4 guesses!\n"
        expect { game.final_message }.to output(harder_phrase).to_stdout
      end
    end
  end
end
